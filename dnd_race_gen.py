...
def dndCharGenRace(param, player):
    if param == "Y":
        # For now this is commented out, Hollow one only available in Wildemount campaign
        '''
        while True:
            print("Hollow Ones are incapable of aging")
            print("Hollow Ones have Resistance against poison damage")
            print("Once per long rest, a Hollow One can cause a creature within 15 feet to have disadvantage on their next saving throw.")
            print("A Hollow One has a 25 percent chance to regain 1 hit point during death saving throws. ")
            print("You gain all of these bonuses. In addition to the race chosen. The downside is that you are considered undead.")
    ...
    if param == "Y":
        ...
        if player.race in subraces:
            ...
            if player.subrace == "Chromatic Dragonborn":
                ...
                player.season = random.choice(seasons)
    #This lineage section is only available if you are playing curse of strahd, will comment for now
    '''
    Line = ["Dhampir", "Hexblood", "Reborn", "No lineage"]
    if param == "Y":
        if ((player.race != "Dhampir") and (player.race != "Hexblood") and (player.race != "Reborn")):
            while True:
                print("Dhampir Lineage can do 'what they do' in addition to what your race does.")
                print("Hexblood Lineage can do 'what they do' in addition to what your race does.")
                print("Reborn Lineage can do 'what they do' in addition to what your race does.")
    ...
    if player.race == "Bugbear":
        ...
        #Combat notes
        player.notes["Surprise Attack"] = "If you surprise a creature and hit it with an attack on your first turn in combat, the attack deals an extra 2d6 damage to it. You can use this trait only once per combat."
    if player.race == "Centaur":
        ...
        player.notes["Equine Build"] = "You count as one size larger when determining your carrying capacity and the weight you can push or drag.\nIn addition, any climb that requires hands and feet is especially difficult for you because of your equine legs. When you make such a climb, each foot of movement costs you 4 extra feet, instead of the normal 1 extra foot."
        #General Notes
        SkillsList = [
    ...
    if player.race == "Corginian":
        ...
        #General Notes
        player.notes["Slippery"] = "You have advantage on Strength (Athletics) and Dexterity (Acrobatics) checks made to escape a grapple."
        #Combat Notes
        player.notes["Strong Jaws"] = "Your jaws are natural weapons, which you can use to make unarmed strikes. If you attack with them, you deal piercing damage equal to 1d4 + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike."
        #Combat notes
        if player.subrace == "Cardigan Corginian":
            player.notes["Keen Smell"] = "Cardigan Corginians have sharp, observant snouts. You have advantage on Intelligence (Investigation) and Wisdom (Perception) checks involving smell."
            #General Notes
        if player.subrace == "Pembroke Corginian":
            player.notes["Keen Hearing"] = "Pembroke Corginians have sharp, observant ears. You have advantage on Intelligence (Investigation) and Wisdom (Perception) checks involving hearing."
            #General Notes
    ...
    if player.race == "Disembodied":
        ...
        if player.level >= 3:
            player.notes["Planar Outcast(2)"] = "You may cast the Blur spell once per day. Intelligence is your spellcasting ability for this spell."
        if player.level >= 5:
            player.notes["Planar Outcast(3)"] = "You may cast the Blink spell once per day. Intelligence is your spellcasting ability for this spell."
    ...
    if player.race == "Elf":
        ...
        if player.subrace == "Dark Elf":
            ...
            if player.level >= 3:
                player.notes["Drow Magic(2)"] = "You can cast the Faerie Fire spell once per day; you must finish a long rest in order to cast the spell again using this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
                player.notes["Drow Magic(3)"] = "You can also cast the Darkness spell once per day; you must finish a long rest in order to cast the spell again using this trait. Charisma is your spellcasting ability for this spell."                            
        ...
        if player.subrace == "High Elf": 
            ...
            for prof in profs:
                if prof not in player.proficiencies:
                    player.proficiencies.append(prof)
            player.notes["Wizard Cantrip"] = "You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it."
            #Spell Notes
            player.notes["Trance"] = "Elves don't need to sleep. Instead, they meditate deeply, remaining semiconscious, for 4 hours a day. (The Common word for such meditation is “trance.”) While meditating, you can dream after a fashion; such dreams are actually mental exercises that have become reflexive through years of practice. After resting in this way, you gain the same benefit that a human does from 8 hours of sleep."
        ...
        if player.subrace == "Shadar-kai":
            ...
            #General notes
            if player.level >= 3:
                player.notes["Blessing of the Raven Queen(2)"] = "You also gain resistance to all damage when you teleport using this trait. The resistance lasts until the start of your next turn. During that time, you appear ghostly and translucent."
                #General noted
            player.notes["Trance"] = "Elves don't need to sleep. Instead, they meditate deeply, remaining semiconscious, for 4 hours a day. (The Common word for such meditation is “trance.”) While meditating, you can dream after a fashion; such dreams are actually mental exercises that have become reflexive through years of practice. After resting in this way, you gain the same benefit that a human does from 8 hours of sleep."
    ...
    if player.race == "Fairy":
        ...
        if player.level >= 3:
            player.notes["Fairy Magic(2)"] = "You can cast the Faerie Fire spell with this trait. Once you cast Faerie Fire with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast this spell using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell when you cast it with this trait (choose when you select this race)."
        if player.level >= 5:
            player.notes["Fairy Magic(3)"] = "You can also cast the Enlarge/Reduce spell with this trait. Once you cast Enlarge/Reduce with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast this spell using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell when you cast it with this trait (choose when you select this race)."
    if player.race == "Firbolg":
        ...
        #Combat Notes
        player.notes["Powerful Build"] = "You count as one size larger when determining your carrying capacity and the weight you can push, drag, or lift."
        player.notes["Speech of Beast and Leaf"] = "You have the ability to communicate in a limited manner with beasts and plants. They can understand the meaning of your words, though you have no special ability to understand them in return. You have advantage on all Charisma checks you make to influence them."
        #General notes
    if player.race == "Gallus":
        ...
        #Combat Notes
        player.notes["Communal"] = f"Whenever you make an Intelligence (History) check related to the history of your race, culture, or community, you are considered proficient in the History skill and add double your proficiency bonus to the check, or {2*player.profbonus}, instead of your normal proficiency bonus."
        #General Notes
    ...
    if player.race == "Genasi":
        ...
        if player.subrace == "Water Genasi":
            ...
            #Spell Notes for (1) and General Notes for (2)
            if player.level >= 3:
                player.notes["Call to the Wave(2)"] = "You can cast the Create or Destroy Water spell once with this trait as a 2nd-level spell, and you regain the ability to cast it this way when you finish a long rest. Constitution is your spellcasting ability for is spell."
    if player.race == "Giff":
        Hmo1 = dice(12)
        Hmo2 = dice(12)
        Hmod = Hmo1 + Hmo2
    ...
    if player.race == "Gith":
        ...
        if player.subrace == "Githyanki":
            ...
            if player.level >= 3:
                player.notes["Githyanki Psionics(2)"] = "You can cast Jump once with this trait, and you regain the ability to do so when you finish a long rest.\nIntelligence is your spellcasting ability for this spell. When you cast it with this trait, it doesn't require components."
            if player.level >= 5:
                player.notes["Githyanki Psionics(3)"] = "You can cast the Misty Step spell once with this trait, and you regain the ability to do so when you finish a long rest.\nIntelligence is your spellcasting ability for this spell. When you cast it with this trait, it doesn't require components."
        ...
        if player.subrace == "Githzerai":
            ...
            #Spell Notes for (1), general notes for (2) and (3)
            if player.level >= 3:
                player.notes["Githzerai Psionics(2)"] = "You can cast Shield once with this trait, and you regain the ability to do so when you finish a long rest.\nWisdom is your spellcasting ability for this spell. When you cast it with this trait, it doesn't require components."
            if player.level >= 5:
                player.notes["Githzerai Psionics(3)"] = "You can cast the Detect Thoughts spell once with this trait, and you regain the ability to do so when you finish a long rest.\nWisdom is your spellcasting ability for this spell. When you cast it with this trait, it doesn't require components."
    ...
    if player.race == "Goblin":
        ...
        #Combat Notes
        player.notes["Nimble Escape"] = "You can take the Disengage or Hide action as a bonus action on each of your turns."
        #Combat Notes
    if player.race == "Goliath":
        ...
        player.notes["Powerful Build"] = "You count as one size larger when determining your carrying capacity and the weight you can push, drag, or lift."
        #General Notes
        player.notes["Mountain Born"] = "You're acclimated to high altitude, including elevations above 20,000 feet. You're also naturally adapted to cold climates, as described in chapter 5 of the Dungeon Master's Guide."
        #General Notes
    if player.race == "Grung":
        ...
        #Combat Notes
        player.notes["Standing Leap"] = "Your long jump is up to 25 feet and your high jump is up to 15 feet, with or without a running start."
        #General Notes
        player.notes["Water Dependency"] = "If you fail to immerse yourself in water for at least 1 hour during a day, you suffer one level of exhaustion at the end of that day. You can only recover from this exhaustion through magic or by immersing yourself in water for at least 1 hour."
        #General Notes
    ...
    if player.race == "Half-Orc":
        ...
        player.notes["Relentless Endurance"] = "When you are reduced to 0 hit points but not killed outright, you can drop to 1 hit point instead. You can't use this feature again until you finish a long rest."
        #Combat Notes
        player.notes["Savage Attacks"] = "When you score a critical hit with a melee weapon attack, you can roll one of the weapon's damage dice one additional time and add it to the extra damage of the critical hit."
        #Combat Notes
    if player.race == "Harengon":
        ...
        #initiative notes
        player.skills.append(dnd_tools.skills["Perception"])
        player.notes["Lucky Footwork"] = "When you fail a Dexterity saving throw, you can use your reaction to roll a d4 and add it to the save, potentially turning the failure into a success. You can't use this reaction if you're prone or your speed is 0."
        #Combat Notes
        player.notes["Rabbit Hop"] = f"As a bonus action, you can jump a number of feet equal to five times your proficiency bonus, or {5*player.profbonus} feet, without provoking opportunity attacks. You can use this trait only if your speed is greater than 0. You can use it {player.profbonus} times, and you regain all expended uses when you finish a long rest."
        #General Notes
    if player.race == "Hedge":
        ...
        #Spell Notes
        player.notes["Speak With Bugs"] = "Through sounds and gestures, you can communicate simple ideas with creatures of the beast subtype that represent insects, spiders, worms, and other creepy crawlies, regardless of their size."
        #General Notes
    if player.race == "Hexblood":
        ...
        #Combat Notes
        player.notes["Hex Magic"] = "You can cast the Disguise Self and Hex spells with this trait. Once you cast either of these spells with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast these spells using any spell slots you have.\nIntelligence, Wisdom, or Charisma is your spellcasting ability for these spells (choose the ability when you gain this lineage)."
        #General Notes
    ...
    if player.race == "Jerbeen":
        ...
        #General Notes
        player.notes["Take Heart"] = "You have advantage on Strength saving throws and saving throws against being frightened as long as you are within 5 feet of an ally who isn't frightened or incapacitated that you can both see and hear."
        #Combat Notes
        player.notes["Team Tactics"] = "You can use the Help action as a bonus action."
        #Combat Notes
    ...
    if player.race == "Kobold":
        ...
        #Combat Notes
        player.notes["Pack Tactics"] = "You have advantage on an attack roll against a creature if at least one of your allies is within 5 feet of the creature and the ally isn't incapacitated."
        #Combat Notes
        player.notes["Sunlight Sensitivity"] = "You have disadvantage on attack rolls and on Wisdom (Perception) checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight."
        #Combat Notes
    ...
    if player.race == "Loxodon":
        ...
        #Combat Notes
        player.notes["Trunk"] = "You can grasp things with your trunk, and you can use it as a snorkel. It has a reach of 5 feet, and it can lift a number of pounds equal to five times your Strength score. You can use it to do the following simple tasks: lift, drop, hold, push, or pull an object or a creature; open or close a door or a container; grapple someone; or make an unarmed strike. Your DM might allow other simple tasks to be added to that list of options.\nYour trunk can't wield weapons or shields or do anything that requires manual precision, such as using tools or magic items or performing the somatic components of a spell."
        #Combat Notes
        player.notes["Keen Smell"] = "Thanks to your sensitive trunk, you have advantage on Perception, Survival, and Investigation checks that involve smell."
        #General Notes
    if player.race == "Luma":
        Hmo1 = dice(4)
        Hmo2 = dice(4)
        ...
        player.notes["Wing Flap"] = "As a bonus action, you can use your powerful feathered arms to propel yourself upward a distance equal to half your movement speed. You can use it in conjunction with a regular jump, but not while gliding."
        #Combat Notes
        player.notes["Touched"] = "You know one cantrip from the sorcerer spell list. Charisma is your spellcasting ability for this cantrip."
        #Spell Notes
    ...
    if player.race == "Mapach":
        ...
        player.notes["Skulker"] = "You have advantage on Stealth checks made in dim light and darkness."
        #General Notes
    ...
    if player.race == "Satyr":
        ...
        #Combat Notes
        player.notes["Mirthful Leaps"] = "Whenever you make a long or high jump, you can roll a d8 and add the number rolled to the number of feet you cover, even when making a standing jump. This extra distance costs movement as normal."
        #General Notes
        player.skills.append(dnd_tools.skills["Performance"])
    ...
    if player.race == "Sharkin":
        ...
        if player.subrace == "Hammerhead Sharkin":
            ...
            player.notes["Ampullae of Lorenzini"] = "You have advantage on Perception and Investigation checks."
            #General Notes
            player.notes["Lateral Vision"] = "You gain a +2 bonus to your passive Perception."
            #General Notes
            ViciousBiteDmg = "1d6"
            if ((player.level >= 5) and (player.level < 10)):
                ViciousBiteDmg = "2d6"
        ...
        if player.subrace == "Edestus":
            ...
            player.notes["Ampullae of Lorenzini"] = "You have advantage on Perception and Investigation checks."
            #General Notes
            player.notes["Razored Teeth"] = "You gain a +2 bonus to attack and damage rolls against unarmored creatures."
            #Combat Notes
            ViciousBiteDmg = "1d6"
            if ((player.level >= 5) and (player.level < 10)):
                ViciousBiteDmg = "2d6"
        ...
        if player.subrace == "Helicoprion":
            ...
            player.notes["Ampullae of Lorenzini"] = "You have advantage on Perception and Investigation checks."
            #General Notes
            player.notes["Hacksaw Jaw"] = "You gain an extra 1d4 slashing damage bonus, against creatures that don't have all their hit points."
            #Combat Notes
            ViciousBiteDmg = "1d6"
            if ((player.level >= 5) and (player.level < 10)):
                ViciousBiteDmg = "2d6"
        ...
        if player.subrace == "Hybodus":
            ...
            player.notes["Dorsal Stinger"] = f"As a bonus action, you may pierce your foe. Your fins have stingers that does {DorsalStingerDmg} piercing damage."
            #Combat Notes
    ...
    if player.race == "Tiefling":
        ...
        if player.subrace == "Asmodeus Subject Tiefling":
            ...
            if player.level >= 3:
                player.notes["Infernal Legacy(2)"] = "You can cast the Hellish Rebuke spell as a 2nd-level spell once with this trait and regain the ability to do so when you finish a long rest. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Baalzebul Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Maladomini(2)"] = "You can cast the Ray of Sickness spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Dispater Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Dis(2)"] = "You can cast the Disguise Self spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Fierna Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Phlegethos(2)"] = "You can cast the Charm Person spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Glasya Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Malbolge(2)"] = "You can cast the Disguise Self spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Levistus Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Stygia(2)"] = "You can cast the Armor of Agathys spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Mammon Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Minauros(2)"] = "You can cast the Tenser's Floating Disk spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Mephistopheles Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Cania(2)"] = "You can cast the Burning Hands spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
        ...
        if player.subrace == "Zariel Subject Tiefling":
            ...
            #Spell Notes for (1), General for rest
            if player.level >= 3:
                player.notes["Legacy of Avernus(2)"] = "You can cast the Searing Smite spell once as a 2nd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
            if player.level >= 5:
                player.notes["Legacy of Avernus(3)"] = "You can also cast the Branding Smite spell once as a 3rd-level spell. You must finish a long rest to cast this spell again with this trait. Charisma is your spellcasting ability for this spell."
    ...
    if player.race == "Tortle":
        ...
        #General Notes
        player.notes["Shell Defense"] = "You can withdraw into your shell as an action. until you emerge, you gain a +4 bonus to AC, and you have advantage on Strength and Constitution saving throws. While in your shell, you are prone, your speed is 0 and can't increase, you have disadvantage on Dexterity saving throws, you can't take reactions, and the only action you can take is a bonus action to emerge from your shell."
        #General Notes
        player.skills.append(dnd_tools.skills["Survival"])
    ...
    if player.race == "Verdan":
        ...
        #General Noted
        player.skills.append(dnd_tools.skills["Persuasion"])
        player.notes["Telepathic Insight"] = "Your mind's connection to the world around you strengthens your will. You have advantage on all Wisdom and Charisma saving throws."
        #Combat Notes
    #Currently Here
    if player.race == "Vulpin":
        ...
        player.notes["Evasive"] = "You add your Intelligence modifier as a bonus on all Dexterity saving throws."
        #General/Combat Notes
        player.notes["Bewitching Guile(1)"] = "You can cast Charm Person as a 1st level spell with this trait, and regain the ability to do so when you finish a long rest. Intelligence is your spellcasting ability for this spell."
        #General notes for all (3)
        if player.level >= 3:
            player.notes["Bewitching Guile(2)"] = "You can cast Ambush Prey as a 2nd level spell with this trait, and regain the ability to do so when you finish a long rest. Intelligence is your spellcasting ability for this spell."
        if player.level >= 5:
            player.notes["Bewitching Guile(3)"] = "You can cast Fear with this trait, and regain the ability to do so when you finish a long rest. Intelligence is your spellcasting ability for this spell."
    ...
    if player.race == "Wechselkind":
        ...
        #General Notes
        player.notes["Childish Agility"] = "You can move through the space of any creature that is of a size larger than yours."
        #General Notes
        player.skills.append(dnd_tools.skills["Acrobatics"])
