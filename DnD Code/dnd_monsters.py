...
monsters = {
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Tail": {
                        ...
                        "Hit Average": 9,
                        "Damage Components": [
                            {"Dice": "1d10", "Modifier": "4", "Type": "Bludgeoning"},
                        ],   
    ...
    "Ape": {
        ...
        "Actions": {
            "Multiattack": {
                ...
                "Attacks": {
                    "Fist": {
                        ...
                        "Hit Average": 5,
                        "Damage Components": [
                            {"Dice": "1d4", "Modifier": "3", "Type": "Bludgeoning"},
                        ],   
                    },
                },
            },
            "Rock": {
                ...
                "Hit Average": 10,
                "Damage Components": [
                    {"Dice": "2d6", "Modifier": "3", "Type": "Bludgeoning"},
                ],   
            },
        },
    }, 
    ...
    "Awakened Tree": {
        ...
        "Actions": {
            "Slam": {
                ...
                "Hit Average": 14,
                "Damage Components": [
                    {"Dice": "3d6", "Modifier": "4", "Type": "Bludgeoning"},
                ],   
            }
        }
    },
    "Axe Beak": {
        ...
        "Actions": {
            "Beak": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d8", "Modifier": "2", "Type": "Slashing"},
                ],   
            }
        }
    },
    "Baboon": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 1,
                "Damage Components": [
                    {"Dice": "1d4", "Modifier": "-1", "Type": "Piercing"},
                ],                   
            }
        }
    },
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Rend": {
                        ...
                        "Hit Average": 5,
                        "Damage Components": [
                            {"Dice": "1d6", "Modifier": "2", "Type": "Slashing"},
                        ],                           
                    }
                }
            }
    ...
    "Boar": {
        ...
        "Actions": {
            "Gore": {
                ...
                "Hit Average": 4,
                "Damage Components": [
                    {"Dice": "1d6", "Modifier": "1", "Type": "Piercing"},
                ],                   
                "Bonus Damage": {
    ...
    "Camel": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 4,
                "Damage Components": [
                    {"Dice": "1d4", "Modifier": "2", "Type": "Bludgeoning"},
                ],                   
            }
        }
    },
    ...
    "Constrictor Snake": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d8", "Modifier": "2", "Type": "Piercing"},
                ],                   
            },
            "Constrict": {
                "Name": "Constrict",
    ...
    "Draft Horse": {
        ...
        "Actions": {
            "Hooves": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d4", "Modifier": "4", "Type": "Bludgeoning"},
                ],                   
            }
        }
    },
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Gore": {
                        ...
                        "Hit Average": 15,
                        "Damage Components": [
                            {"Dice": "2d8", "Modifier": "6", "Type": "Piercing"},
                        ],                        
    ...
    "Eagle": {
        ...
        "Actions": {
            "Talons": {
                ...
                "Hit Average": 4,
                "Damage Components": [
                    {"Dice": "1d4", "Modifier": "2", "Type": "Slashing"},
                ],                
            }
        }
    },
    "Elk": {
        ...
        "Actions": {
            "Ram": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d6", "Modifier": "3", "Type": "Bludgeoning"},
                ],                
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Fist": {
                        ...
                        "Hit Average": 22,
                        "Damage Components": [
                            {"Dice": "3d10", "Modifier": "6", "Type": "Bludgeoning"},
                        ],                        
                    }
                }
            },
    ...
    "Giant Badger": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "2d4", "Modifier": "1", "Type": "Piercing"},
                ],                
            }
        }
    },
    "Giant Bat": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d6", "Modifier": "3", "Type": "Piercing"},
                ],                
            }
        }
    },
    "Giant Boar": {
        ...
        "Actions": {
            "Gore": {
                ...
                "Hit Average": 10,
                "Damage Components": [
                    {"Dice": "2d6", "Modifier": "3", "Type": "Piercing"},
                ],                
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 11,
                        "Damage Components": [
                            {"Dice": "2d6", "Modifier": "4", "Type": "Piercing"},
                        ],                        
                    },
                    "Constrict": {
                        "Name": "Constrict",
                        ...
                        "Hit Average": 13,
                        "Damage Components": [
                            {"Dice": "2d8", "Modifier": "4", "Type": "Bludgeoning"},
                        ],                        
                        "Effect": {
                            "Name": "Grappled",
                            "Escape Modifier": "STR",
    ...
    "Giant Crab": {
        ...
        "Actions": {
            "Claw": {
                ...
                "Target Size": "Medium",
                "Damage Components": [
                    {"Dice": "1d6", "Modifier": "1", "Type": "Bludgeoning"},
                ],                
                "Effect": {
                    "Name": "Grappled",
                    "Escape Modifier": "STR",
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 21,
                        "Damage Components": [
                            {"Dice": "3d10", "Modifier": "5", "Type": "Piercing"},
                        ],                        
                        "Effect": {
                            "Name": "Grappled (Restrained)",
                            "Escape Modifier": "STR",
                    ...
                    "Tail": {
                        ...
                        "Hit Average": 18,
                        "Damage Components": [
                            {"Dice": "3d8", "Modifier": "5", "Type": "Bludgeoning"},
                        ],                        
    ...
    "Giant Owl": {
        ...
        "Actions": {
            "Talons": {
                ...
                "Hit Average": 7,
                "Damage Components": [
                    {"Dice": "1d10", "Modifier": "2", "Type": "Slashing"},
                ],                
            },
            "Spellcasting": {
                "Name": "Spellcasting",
    ...
    "Giant Seahorse": {
        ...
        "Actions": {
            "Ram": {
                ...
                "Hit Average": 9,
                "Damage Components": [
                    {"Dice": "2d6", "Modifier": "2", "Type": "Bludgeoning"},
                ],                
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 22,
                        "Damage Components": [
                            {"Dice": "3d10", "Modifier": "6", "Type": "Piercing"},
                        ],                        
                    }
                }
            }
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 28,
                        "Damage Components": [
                            {"Dice": "4d10", "Modifier": "6", "Type": "Piercing"},
                        ],                        
                    },
                    "Tentacle": {
                        "Name": "Tentacle",
                        ...
                        "Hit Average": 19,
                        "Damage Components": [
                            {"Dice": "3d8", "Modifier": "6", "Type": "Bludgeoning"},
                        ],                        
                        "Effect": {
                            "Name": "Grappled",
                            "Escape Modifier": "STR",
    ...
    "Giant Vulture": {
        ...
        "Actions": {
            "Gouge": {
                ...
                "Hit Average": 9,
                "Damage Components": [
                    {"Dice": "2d6", "Modifier": "2", "Type": "Piercing"},
                ],                
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 16,
                        "Damage Components": [
                            {"Dice": "2d10", "Modifier": "5", "Type": "Piercing"},
                        ],                        
                    }
                }
            }
    ...
    "Hunter Shark": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 14,
                "Damage Components": [
                    {"Dice": "3d6", "Modifier": "4", "Type": "Piercing"},
                ],                
            }
        }
    },
    ...
    "Killer Whale": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 21,
                "Damage Components": [
                    {"Dice": "5d6", "Modifier": "4", "Type": "Piercing"},
                ],                
            }
        }
    },
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Rend": {
                        ...
                        "Hit Average": 7,
                        "Damage Components": [
                            {"Dice": "1d8", "Modifier": "3", "Type": "Slashing"},
                        ],                        
                    },
                    "Roar": {
                        "Name" : "Roar",
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Gore": {
                        ...
                        "Hit Average": 18,
                        "Damage Components": [
                            {"Dice": "2d10", "Modifier": "7", "Type": "Piercing"},
                        ],                        
    ...
    "Panther": {
        ...
        "Actions": {
            "Rend": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "1d6", "Modifier": "3", "Type": "Slashing"},
                ],                
            }
        },
        "Bonus Actions": {
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Rend": {
                        ...
                        "Hit Average": 9,
                        "Damage Components": [
                            {"Dice": "1d8", "Modifier": "5", "Type": "Slashing"},
                        ],                        
                    }
                }
            }
    ...
    "Reef Shark": {
        ...
        "Actions": {
            "Bite": {
                ...
                "Hit Average": 7,
                "Damage Components": [
                    {"Dice": "2d4", "Modifier": "2", "Type": "Piercing"},
                ],                
            }
        }
    },
    "Rhinoceros": {
        ...
        "Actions": {
            "Gore": {
                ...
                "Hit Average": 14,
                "Damage Components": [
                    {"Dice": "2d8", "Modifier": "5", "Type": "Piercing"},
                ],                
    ...
    "Riding Horse": {
        ...
        "Actions": {
            "Hooves": {
                ...
                "Hit Average": 7,
                "Damage Components": [
                    {"Dice": "1d8", "Modifier": "3", "Type": "Bludgeoning"},
                ],                
            }
        }
    },
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Rend": {
                        ...
                        "Hit Average": 11,
                        "Damage Components": [
                            {"Dice": "2d6", "Modifier": "4", "Type": "Slashing"},
                        ],                        
                    }
                }
            }
    ...
    "Swarm of Insects": {
        ...
        "Actions": {
            "Bites": {
                ...
                "Hit Average": 6,
                "Damage Components": [
                    {"Dice": "2d4", "Modifier": "1", "Type": "Poison"},
                ],                
                "Conditional Extra": {
                    "Condition": "Bloodied",
                    "Damage": "1d4+1",
    ...
    "Swarm of Piranhas": {
        ...
        "Traits": {
            ...
            "Blood Frenzy": "The swarm of piranhas has advantage on melee attack rolls against any creature that doesn't have all its hit points.",
        },
        "Actions": {
            "Bites": {
                "Name" : "Bites",
                ...
                "Hit Average": 8,
                "Damage Components": [
                    {"Dice": "2d4", "Modifier": "3", "Type": "Piercing"},
                ],                
                "Conditional Extra": {
                    "Condition": "Bloodied",
                    "Damage": "1d4 + 3",
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Gore": {
                        ...
                        "Hit Average": 19,
                        "Damage Components": [
                            {"Dice": "2d12", "Modifier": "6", "Type": "Piercing"},
                        ],                        
            ...
            "Multiattack": {
                ...
                "Attacks": {
                    "Bite": {
                        ...
                        "Hit Average": 33,
                        "Damage Components": [
                            {"Dice": "4d12", "Modifier": "7", "Type": "Piercing"},
                        ],                        
                        "Effect": {
                            "Name": "Grappled (Restrained)",
                            "Escape Modifier": "STR",
                    ...
                    "Tail": {
                        ...
                        "Hit Average": 25,
                        "Damage Components": [
                            {"Dice": "4d8", "Modifier": "7", "Type": "Bludgeoning"},
                        ],                        
    ...
    "Warhorse": {
        ...
        "Actions": {
            "Hooves": {
                ...
                "Hit Average": 9,
                "Damage Components": [
                    {"Dice": "2d4", "Modifier": "4", "Type": "Bludgeoning"},
                ],                
    ...
    "Zombie": {
        ...
        "Actions": {
            "Slam": {
                ...
                "Hit Average": 5,
                "Damage Components": [
                    {"Dice": "1d8", "Modifier": "1", "Type": "Bludgeoning"},
                ],                
            }
        }
    },   
