    ...
    for i in range(len(Class)):
        ...
        if Class[i] == "Barbarian":
            ...
            if barblvl >= 1:
                ...
                ClassNotes.append(f"Unarmored Defense - While you are not wearing any armor, your Armor Class equals {10 + DexMod + ConMod}. You can use a shield and still gain this benefit.")
            if barblvl >= 2:
            ...
            if barblvl >= 3:
                ...
                if subclass[i] == "Path of the Beast Barbarian":
                    ...
                    Notes.append("Form of the Beast - When you enter your rage, you can transform, revealing the bestial power within you. Until the rage ends, you manifest a natural weapon. It counts as a simple melee weapon for you, and you add your Strength modifier to the attack and damage roll when you attack with it, as normal.\nYou choose the weapon's form each time you rage:\nBite - Your mouth transforms into a bestial muzzle or great mandibles (your choice). It deals 1d8 piercing damage on a hit. Once on each of your turns when you damage a creature with this bite, you regain a number of hit points equal to your proficiency bonus, provided you have less than half your hit points when you hit.\nClaws - Each of your hands transforms into a claw, which you can use as a weapon if it's empty. It deals 1d6 slashing damage on a hit. Once on each of your turns when you attack with a claw using the Attack action, you can make one additional claw attack as part of the same action.\nTail - You grow a lashing, spiny tail, which deals 1d8 piercing damage on a hit and has the reach property. If a creature you can see within 10 feet of you hits you with an attack roll, you can use your reaction to swipe your tail and roll a d8, applying a bonus to your AC equal to the number rolled, potentially causing the attack to miss you.")
                    if barblvl >= 6:
                    ...
                    if barblvl >= 10:
                        ...
                        Notes.append(f"Infectious Fury - When you hit a creature with your natural weapons while you are raging, the beast within you can curse your target with rabid fury. The target must succeed on a Wisdom saving throw (DC equal to 8 + your Constitution modifier+ your proficiency bonus) or suffer one of the following effects (your choice):\n- The target must use its reaction to make a melee attack against another creature of your choice that you can see.\n- The target takes 2d12 psychic damage.\nYou can use this feature {ProfBonus} times, and you regain all expended uses when you finish a long rest.")
                    if barblvl >= 14:
                ...
                if subclass[i] == "Path of the Giant Barbarian":
                    ...
                    if barblvl >= 10:
                        ...
                        Notes.append("Mighty Impel - Your connection to giant strength allows you to hurl both allies and enemies on the battlefield. As a bonus action while raging, you can choose one Medium or smaller creature within your reach and move it to an unoccupied space you can see within 30 feet of yourself. An unwilling creature must succeed on a Strength saving throw (DC equals 8 + your proficiency bonus + your Strength modifier) to avoid the effect.\nIf, at the end of this movement, the thrown creature isn't on a surface or liquid that can support it, the creature falls, taking damage as normal and landing prone.")
                    if barblvl >= 14:
                ...
                if subclass[i] == "Path of the Totem Warrior Barbarian":
                    ...
                    if barblvl >= 14:
                        ...
                        Notes.append("Totemic Attunement - You gain a magical benefit based on a totem animal of your choice. You can choose the same animal you selected previously or a different one.\nBear - While you're raging, any creature within 5 feet of you that's hostile to you has disadvantage on attack rolls against targets other than you or another character with this feature. An enemy is immune to this effect if it can't see or hear you or if it can't be frightened.\nEagle - While raging, you have a flying speed equal to your current walking speed. This benefit works only in short bursts; you fall if you end your turn in the air and nothing else is holding you aloft.\nElk - While raging, you can use a bonus action during your move to pass through the space of a Large or smaller creature. That creature must succeed on a Strength saving throw (DC 8 + your Strength bonus + your proficiency bonus) or be knocked prone and take bludgeoning damage equal to 1d12 + your Strength modifier.\nTiger - While you're raging, if you move at least 20 feet in a straight line toward a Large or smaller target right before making a melee weapon attack against it, you can use a bonus action to make an additional melee weapon attack against it.\nWolf - While you're raging, you can use a bonus action on your turn to knock a Large or smaller creature prone when you hit it with melee weapon attack.")
                if subclass[i] == "Path of the Zealot Barbarian":
                    ClassNotes.append("Divine Fury - You can channel divine fury into your weapon strikes. While you're raging, the first creature you hit on each of your turns with a weapon attack takes extra damage equal to 1d6 + half your Barbarian level. The extra damage is necrotic or radiant; you choose the type of damage when you gain this feature.")
            ...
            if bardlvl >= 3:
                ...
                if subclass[i] == "College of Creation Bard":
                    ...
                    if bardlvl >= 14:
                        ...
                        Notes.append(f"Creation Crescendo - When you use your Performance of Creation feature, you can create more than one item at once (minimum of two items), specifically {ChaMod} times. If you create an item that would exceed that number, you choose which of the previously created items disappears. Only one of these items can be of the maximum size you can create; the rest must be Small or Tiny.\nYou are no longer limited by gp value when creating items with Performance of Creation.")
                if subclass[i] == "College of Eloquence Bard":
                    ...
                    if bardlvl >= 6:
                        ...
                        Notes.append("Universal Speech - You have gained the ability to make your speech intelligible to any creature. As an action, choose one or more creatures within 60 feet of you, up to a number equal to your Charisma modifier (minimum of one creature). The chosen creatures can magically understand you, regardless of the language you speak, for 1 hour.\nOnce you use this feature, you can't use it again until you finish a long rest, unless you expend a spell slot to use it again.")
                    if bardlvl >= 14:
                        ClassNotes.append("Infectious Inspiration (see notes)")
                        Notes.append(f"Infectious Inspiration - \nWhen you successfully inspire someone, the power of your eloquence can now spread to someone else. When a creature within 60 feet of you adds one of your Bardic Inspiration dice to its ability check, attack roll, or saving throw and the roll succeeds, you can use your reaction to encourage a different creature (other than yourself) that can hear you within 60 feet of you, giving it a Bardic Inspiration die without expending any of your Bardic Inspiration uses.\nYou can use this reaction {ChaMod} times (minimum of once), and you regain all expended uses when you finish a long rest.")
                if subclass[i] == "College of Glamour Bard":
                    ...
                    if bardlvl >= 14:
                        ...
                        Notes.append("Unbreakable Majesty - Your appearance permanently gains an otherworldly aspect that makes you look more lovely and fierce.\nIn addition, as a bonus action, you can assume a magically majestic presence for 1 minute or until you are incapacitated. For the duration, whenever any creature tries to attack you for the first time on a turn, the attacker must make a Charisma saving throw against your spell save DC. On a failed save, it can't attack you on this turn, and it must choose a new target for its attack or the attack is wasted. On a successful save, it can attack you on this turn, but it has disadvantage on any saving throw it makes against your spells on your next turn.\nOnce you assume this majestic presence, you can't do so again until you finish a short or long rest.")
        ...
        if Class[i] == "Cleric":
            ...
            if clerlvl >= 10:
                ...
                Notes.append("Divine Intervention(1) - You can call on your deity to intervene on your behalf when your need is great.\nImploring your deity’s aid requires you to use your action. Describe the assistance you seek, and roll percentile dice. If you roll a number equal to or lower than your cleric level, your deity intervenes. The DM chooses the nature of the intervention; the effect of any cleric spell or cleric domain spell would be appropriate.\nIf your deity intervenes, you can’t use this feature again for 7 days. Otherwise, you can use it again after you finish a long rest.")
            if clerlvl >= 11:
                ClericSpellSlot6 = 1
            if clerlvl >= 13:
                ClericSpellSlot7 = 1
        ...
        if Class[i] == "Druid":
            ...
            if drulvl >= 2: 
                ...
                Notes.append(f"Wild Companion - You gain the ability to summon a spirit that assumes an animal form: as an action, you can expend a use of your Wild Shape feature to cast the Find Familiar spell, without material components.\nWhen you cast the spell in this way, the familiar is a fey instead of a beast, and the familiar disappears after a number of hours equal to {drulvl / 2}. This beast follows the same rules as Wild Shape, in that the Max CR is {WildShapeCR} and if it is limited, it is limited by {WildShapeLimitations}.")
            if drulvl >= 2:
                ...
                if subclass[i] == "Circle of Spores Druid":
                    ...
                    Notes.append(f"Symbiotic Entity - You gain the ability to channel magic into your spores. As an action, you can expend a use of your Wild Shape feature to awaken those spores, rather than transforming into a beast form, and you gain {5*drulvl} temporary hit points. While this feature is active, you gain the following benefits:\n- When you deal your Halo of Spores damage, roll the damage die a second time and add it to the total.\n- Your melee weapon attacks deal an extra 1d6 poison damage to any target they hit.\nThese benefits last for 10 minutes, until you lose all these temporary hit points, or until you use your Wild Shape again.")
                    if drulvl >= 6:
            ...
            if figlvl >= 1:
                ...
                if i == 0:       
                    ...
                    if "Martial Weapons" not in PlProf:
                        PlProf.append("Martial Weapons")                                                                              
            ClassNotes.append("Fighting Style (see notes)")
            Notes.append(f"Fighting Style - You adopt a particular style of fighting as your specialty. Choose one of the following options. You can’t take a Fighting Style option more than once, even if you later get to choose again.\n- Archery - You gain a +2 bonus to attack rolls you make with ranged weapons.\n- Blind Fighting - You have blindsight with a range of 10 feet. Within that range, you can effectively see anything that isn't behind total cover, even if you're blinded or in darkness. Moreover, you can see an invisible creature within that range, unless the creature successfully hides from you.\n- Defense - While you are wearing armor, you gain a +1 bonus to AC.\n- Dueling - When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon.\n- Great Weapon Fighting - When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed or versatile property for you to gain this benefit.\n- Interception - When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by 1d10 + your proficiency bonus, {ProfBonus}, to a minimum of 0 damage. You must be wielding a shield or a simple or martial weapon to use this reaction.\n- Protection - When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield.\n- Superior Technique - You learn one maneuver of your choice from among those available to the Battle Master archetype. If a maneuver you use requires your target to make a saving throw to resist the maneuver's effects, the saving throw DC equals {8 + ProfBonus} + your Strength or Dexterity modifier (your choice). You gain one superiority die, which is a d6 (this die is added to any superiority dice you have from another source). This die is used to fuel your maneuvers. A superiority die is expended when you use it. You regain your expended superiority dice when you finish a short or long rest.\n- Thrown Weapon Fighting - You can draw a weapon that has the thrown property as part of the attack you make with the weapon. In addition, when you hit with a ranged attack using a thrown weapon, you gain a +2 bonus to the damage roll.\n- Two-Weapon Fighting - When you engage in two-weapon fighting, you can add your ability modifier to the damage of the second attack.\n- Unarmed Fighting - Your unarmed strikes can deal bludgeoning damage equal to 1d6 + your Strength modifier, {StrMod} on a hit. If you aren't wielding any weapons or a shield when you make the attack roll, the d6 becomes a d8. At the start of each of your turns, you can deal 1d4 bludgeoning damage to one creature grappled by you.")
            ...
            if figlvl >= 3:
                ...
                if subclass[i] == "Cavalier Archetype Fighter":
                    ...
                    if figlvl >= 15:
                        ...
                        Notes.append(f"Ferocious Charger - You can run down your foes, whether you're mounted or not. If you move at least 10 feet in a straight line right before attacking a creature and you hit it with the attack, that target must succeed on a Strength saving throw, DC {8 + ProfBonus + StrMod}, or be knocked prone. You can use this feature only once on each of your turns.")
                    if figlvl >= 18:
                ...
                if subclass[i] == "Champion Archetype Fighter":
                    ...
                    if figlvl >= 7:
                        ClassNotes.append(f"Remarkable Athlete - You can add {math.ceil(ProfBonus/2)} to any Strength, Dexterity, or Constitution check you make that doesn't already use your proficiency bonus.\nIn addition, when you make a running long jump, the distance you can cover increases by a number of feet equal to {StrMod}.")
                    if figlvl >= 10:
                    ...
                    if figlvl >= 18:
                        ClassNotes.append(f"Survivor - You attain the pinnacle of resilience in battle. At the start of each of your turns, you regain hit points equal to {5 + ConMod} if you have no more than half of your hit points left. You don't gain this benefit if you have 0 hit points.")
                if subclass[i] == "Echo Knight Archetype Fighter":
                    ...
                    if figlvl >= 15:                                                                  
                        ...
                        Notes.append(f"Reclaim Potential - You've learned to absorb the fleeting magic of your echo. When an echo of yours is destroyed by taking damage, you can gain a number of temporary hit points equal to 2d6 + {ConMod}, provided you don't already have temporary hit points.\nYou can use this feature a number of times equal to your Constitution modifier (a minimum of once), or {ConMod}. You regain all expended uses when you finish a long rest.")  
                    if figlvl >= 18:
        ...
        if Class[i] == "Monk":
            ...
            if monklvl >= 1:
                ...
                if i == 0:
                    ...
                    if Shortsword not in PlProf:
                        PlProf.append(Shortsword)  
            ClassNotes.append(f"Unarmored Defense - While you are wearing no armor and not wielding a shield, your AC equals {10 + DexMod + WisMod}.")
            MartialArts = "1d4"
            if monklvl >= 2:   
                KiPoints = 2
            ...
            if monklvl >= 4:
                KiPoints = 4
                ClassNotes.append(f"Slow Fall - You can use your reaction when you fall to reduce any falling damage you take by an amount equal to {5 * monklvl}.")
                ClassNotes.append(f"Quickened Healing - As an action, you can spend 2 ki points and roll a Martial Arts die. You regain a number of hit points equal to the number rolled plus your proficiency bonus, or {ProfBonus}.")
            if monklvl >= 5:
                KiPoints = 5
                MartialArts = "1d6"
                ClassNotes.append("Extra Attack - You can attack twice, instead of once, whenever you take the Attack action on your turn.")
        ...
        if Class[i] == "Paladin":
            ...
            if pallvl >= 2:    
                ...
                PaladinSpellSlot5 = 0 
                ClassNotes.append("Fighting Style (see notes)")
                Notes.append(f"Fighting Style - You adopt a particular style of fighting as your specialty. Choose one of the following options. You can’t take a Fighting Style option more than once, even if you later get to choose again.\n- Blessed Warrior - You learn two cantrips of your choice from the cleric spell list. They count as paladin spells for you, and Charisma is your spellcasting ability for them. Whenever you gain a level in this class, you can replace one of these cantrips with another cantrip from the cleric spell list.\n- Blind Fighting - You have blindsight with a range of 10 feet. Within that range, you can effectively see anything that isn't behind total cover, even if you're blinded or in darkness. Moreover, you can see an invisible creature within that range, unless the creature successfully hides from you.\n- Defense - While you are wearing armor, you gain a +1 bonus to AC.\n- Dueling - When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon.\n- Great Weapon Fighting - When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed or versatile property for you to gain this benefit.\n- Interception - When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by 1d10 + your proficiency bonus, or {ProfBonus}, to a minimum of 0 damage. You must be wielding a shield or a simple or martial weapon to use this reaction.\n- Protection - When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield.")
            ...
            if pallvl >= 5:
                ...
                ClassNotes.append("Extra Attack - You can attack twice, instead of once, whenever you take the Attack action on your turn.")
            if pallvl >= 6:
                ClassNotes.append("Aura of Protection(1) - Whenever you or a friendly creature within 10 feet of you must make a saving throw, the creature gains a bonus to the saving throw equal to your Charisma modifier (with a minimum bonus of +1). You must be conscious to grant this bonus.")
            if pallvl >= 7:
                PaladinSpellSlot2 = 3
            if pallvl >= 9:
                PaladinSpellSlot3 = 2
            ...
            if warlvl >= 1:
                ...
                if subclass[i] == "Celestial Patron Warlock":
                    ...
                    if warlvl >= 10:
                        ...
                        Notes.append(f"Celestial Resistance - You gain temporary hit points whenever you finish a short or long rest. These temporary hit points equal {warlvl + ChaMod}. Additionally, choose up to five creatures you can see at the end of the rest. Those creatures each gain temporary hit points equal to {math.floor((warlvl+ChaMod)/2)}.")
                    if warlvl >= 14:
        ...
        if Class[i] == "Wizard":
            ...
            if wizlvl >= 2:
                ...
                if subclass[i] == "Abjuration Arcane Tradition Wizard":
                    ...
                    if wizlvl >= 10:
                        ClassNotes.append(f"Improved Abjuration - When you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in Counterspell and Dispel Magic), you add your proficiency bonus, {ProfBonus}, to that ability check.")
                    if wizlvl >= 14:
                ...
                if subclass[i] == "War Magic Arcane Tradition Wizard":
                    ...
                    if wizlvl >= 14:
                        ClassNotes.append(f"Deflecting Shroud - Your Arcane Deflection becomes infused with deadly magic. When you use your Arcane Deflection feature, you can cause magical energy to arc from you. Up to three creatures of your choice within 60 feet of you each take force damage equal to {math.floor(wizlvl/2)}.")
                WizardSpellSlot1 = 3
            if wizlvl >= 3:                    
                WizardSpellSlot1 = 4
                WizardSpellSlot2 = 2
