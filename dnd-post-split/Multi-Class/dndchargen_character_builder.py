...
def dndchargen_characterbuilder(param, plLvl, playername, charactername, race, Class, subclass, submulticlass, BeachballFlag, BGL, EQP, SkillsProf, PlProf, PlLang, SLANG, Notes, data, skills_dict, FeatTrait):
    ...
    with open(filename, "w") as file:
        ...
        for note in Notes:
            file.write("-"+note+"\n\n")    
    #Do an if check... here? For any of the backgrounds and races and do the appends now (example the scalable damage done by Summer Eladrin), wait no! They should all use pllvl, and therefore need no movement.
